    ...
    Box(modifier = Modifier
        ...
        Column(
            ...
            Row(
                ...
                Icon(
                    Icons.Filled.Close,
                    "close", modifier = Modifier.padding(start = 5.dp)
                )
                Text("Log In or Sign Up", style = AeonikTypography.h5, fontWeight = FontWeight.Bold)
                Text("")
            }
            ...
            Spacer(modifier = Modifier.padding(top = 30.dp))
            Row() {
                Text("Don't have an account?", style = AeonikTypography.body2, color = Color.Gray)
